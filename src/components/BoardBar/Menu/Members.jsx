...
function Members() {
  return (
    <>
      ...
      <AvatarGroup max={4} sx={{ gap: '2px', '& .MuiAvatar-root' : { border: '2px solid transparent' }, '& .MuiAvatar-root:hover' : { borderColor: 'rgba(255,255,255,0.4)' }, mr: '2px' }} slotProps={{ additionalAvatar: { sx: { width: '30px', height: '30px', borderColor: 'transparent' } } }} >
        <Avatar src={myavt3} sx={{ width: '32px', height: '32px' }}/>
        <Avatar src={sneeze2} sx={{ width: '32px', height: '32px' }}/>
